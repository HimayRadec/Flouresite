...
public class scr_CharacterController : MonoBehaviour
{
    ...
    public float stanceTransitionSmoothing;
    ...
    private void SetIsGrounded()
    {
        ...
        isGrounded = Physics.CheckSphere(feet.position, playerSettings.isGroundedRadius, groundMask);
    }
    ...
    private void CalculateStance()
    {
        ...
        cameraHeight = Mathf.SmoothDamp(cameraHolder.localPosition.y, currentStance.CameraHeight, ref cameraHeightVelocity, stanceTransitionSmoothing);
        cameraHolder.localPosition = new Vector3(cameraHolder.localPosition.x, cameraHeight, cameraHolder.localPosition.z);

        characterController.height = Mathf.SmoothDamp(characterController.height, currentStance.StanceCollider.height, ref stanceCapsuleHeightVelocity, stanceTransitionSmoothing);
        characterController.center = Vector3.SmoothDamp(characterController.center, currentStance.StanceCollider.center, ref stanceCapsuleCenterVelocity, stanceTransitionSmoothing);
    }
    ...
    {
        var start = new Vector3(feet.position.x, feet.position.y + characterController.radius + StanceCheckErrorMargin, feet.position.z);
        var end = new Vector3(feet.position.x, feet.position.y - characterController.radius - StanceCheckErrorMargin + stanceCheckHeight, feet.position.z);
    ...
    public void BuyAmmo()
    {
        ...
        if (Physics.Raycast(ray, out hitInfo, 5f, mask))
        {
            ...
            if (hitInfo.collider.GetComponent<scr_BuyAmmo>() != null)
            {
